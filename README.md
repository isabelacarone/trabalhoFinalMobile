...
A técnica Pomodoro é baseada na ideia de dividir o trabalho em intervalos de tempo, chamados de “pomodoros”, que são períodos de 25 minutos de foco intenso seguidos por uma pausa curta de 5 minutos. E é recomendado fazer uma pausa mais longa após 4 "pomodoros", sendo ela, geralmente, de 15 a 30 minutos.
...
- **React Native Paper**: componentes estilizados para UI (interface do usuário).
...
- Ter o [Expo CLI](https://docs.expo.dev/) instalado globalmente (ou usar `npx expo`)

### Passos

```bash
git clone https://github.com/isabelacarone/trabalhoFinalMobile.git
cd pomodorotimer
